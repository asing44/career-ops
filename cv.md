...
Raleigh, NC | (412) 926-8464 | adamjwarsing@gmail.com

[Portfolio](https://adam-warsing.webflow.io) | [LinkedIn](https://linkedin.com/in/adam-j-warsing)

## Summary

Solutions Developer and Frontend Developer combining UI/UX design, accessible interface development, and enterprise systems delivery. Builds responsive web experiences and mobile EAM solutions using JavaScript, React, Webflow/WordPress, TAShelix, REST/web services, and AI-assisted workflows. Applies AI to accelerate analysis, documentation, and implementation planning across complex legacy environments, translating technical findings into clear, client-ready outcomes.
...
- Configure and maintain mobile EAM applications through enterprise platform upgrades, including SubApp development, UI resizing, cloning, and web-service integration.
- Apply AI-assisted development and analysis workflows to transform complex enterprise data and legacy documentation into structured findings, queries, and implementation-ready deliverables.
...
- Designed and launched 10+ responsive marketing sites in Webflow and WordPress, emphasizing visual storytelling and intuitive UI patterns.
...
GPA: 3.8 | Dean's List, four consecutive semesters
...
- User-centered design, wireframing, prototyping, and usability testing principles.

## Skills

**Languages and Frameworks:** HTML5, CSS3, JavaScript (ES6+), PHP (Basic), React (Foundational), Vue.js (Basic), GSAP, React Three Fiber (Learning), Tailwind CSS, Bootstrap

**Platforms and Tools:** Webflow, WordPress (Custom Themes, ACF, Elementor), Git / GitHub, Figma, Adobe Suite (Illustrator, Photoshop, After Effects, XD), Blender

**Integrations and Performance:** REST API Integration, Core Web Vitals, Lighthouse Auditing, SEO Optimization, Google Analytics, Search Console, Tag Manager, Hotjar

**Enterprise and Workflow:** TAShelix (EAM Mobile), Web Service Configuration, SubApp Development, Coda.io, Airtable, ClickUp, Notion, Slack
